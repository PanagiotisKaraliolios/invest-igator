...
**Step 1: Sign Up**
```json
POST {{baseUrl}}/api/trpc/auth.signup
...
```json
POST {{baseUrl}}/api/trpc/account.getMe
...
**Add a Symbol**
```json
POST {{baseUrl}}/api/trpc/watchlist.add
...
```json
POST {{baseUrl}}/api/trpc/watchlist.list
...
**Get Price History**
```json
POST {{baseUrl}}/api/trpc/watchlist.history
...
```json
POST {{baseUrl}}/api/trpc/transactions.create
...
**List Transactions**
```json
POST {{baseUrl}}/api/trpc/transactions.list
...
```json
POST {{baseUrl}}/api/trpc/portfolio.structure
...
```json
POST {{baseUrl}}/api/trpc/portfolio.performance
...
**Create API Key**
```json
POST {{baseUrl}}/api/trpc/apiKeys.create
...
```json
POST {{baseUrl}}/api/trpc/transactions.importCsv
...
**Set User Role**
```json
POST {{baseUrl}}/api/trpc/admin.setRole
