...
Sign-up is handled natively by Better Auth (not a tRPC endpoint). Passwords must be at least 12 characters and contain both letters and numbers.
...
Session cookie set automatically; returns the created user
```
