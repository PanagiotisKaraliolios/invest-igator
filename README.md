...
- ⏰ Cron labels run `ingest-yahoo` daily at 02:15 UTC, `ingest-fx` at 06:00/18:00 UTC and the AI-quota sweep every 5 minutes (Ofelia schedules have a leading seconds field)
